...
int main(int argc, char *argv[])
{
    ...
    /*for (int i = 0; i < min(5, nbPoints); i++){
        for (int j = 0; j < min(5, sizePoint); j++){
            cout << points[i * sizePoint + j] << " ";
        }
        cout << "--> " << idxToLabel[labels[i]] << "\n";
    }*/
    ...
    /* --------------- Definindo os pontos na GPU e alocando memória -------------- */
    startMemo = clock();
